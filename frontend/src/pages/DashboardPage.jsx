  ...
  return (
    <div className="stack-lg">
        ...
        <article className="panel">
          ...
          {mine?.active_policy ? (
            <div className="stack-sm">
              ...
              <p>
                Coverage hours: <strong>{mine.active_policy.coverage_hours} hrs / week</strong>
              </p>
      ...
      <section className="two-column">
        ...
        <article className="panel">
          <p className="eyebrow">Active triggers</p>
          <h3>What RouteRelief is monitoring</h3>
          <div className="stack-sm">
            {mine?.active_disruption_triggers?.length ? (
              mine.active_disruption_triggers.map((trigger) => (
              ...
              <p className="muted">No active disruption triggers for your zone right now.</p>
            )}
          </div>
        </article>
      </section>
