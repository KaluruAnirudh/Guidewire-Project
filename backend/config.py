...
class Config:
    ...
    SECRET_KEY = os.getenv("SECRET_KEY", "gig-insure-secret")
    JWT_SECRET_KEY = os.getenv("JWT_SECRET_KEY", "gig-insure-jwt-secret")
    MONGODB_URI = os.getenv("MONGODB_URI", "mongodb://localhost:27017/gig_insure")
