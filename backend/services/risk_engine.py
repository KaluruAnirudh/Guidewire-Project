...
from services.disruption_trigger_service import evaluate_automated_triggers
...
def build_zone_snapshot(location, claim_reason=None):
    ...
    trigger_snapshot = evaluate_automated_triggers(normalized_location)
    environment = trigger_snapshot["environment"]
    ...
    return {
        ...
        "waterlogging_risk": trigger_snapshot["waterlogging_risk"],
        "forecast_disruption_hours": trigger_snapshot["forecast_disruption_hours"],
        "automated_triggers": trigger_snapshot["automated_triggers"],
        "monitored_trigger_count": trigger_snapshot["monitored_trigger_count"],
        "civic_alert": trigger_snapshot["civic_alert"],
